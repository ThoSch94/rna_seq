...
-o CDS_counts_rawfile.txt /data/users/tschiller/RNA_seq/processed_data/*_GRCh38_sorted.bam
...
-g gene_biotype \
-a /data/users/tschiller/RNA_seq/Raw_data/annotation/DNA_annotation/Homo_sapiens.GRCh38.110.gtf \
-o biotype_counts_rawfile.txt /data/users/tschiller/RNA_seq/processed_data/*_GRCh38_sorted.bam
